module vulkan-examples/05_cube
...
require (
	...
	github.com/tomas-mraz/vulkan v0.0.0-20260414190643-4a7e82813554
	github.com/tomas-mraz/vulkan-ash v0.0.0-20260415082901-a378a90fb682
)
